...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        ...
        _______, _______,  ______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,    _______,       _______, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_NUBS, S(KC_NUBS), ALGR(KC_NUBS),          _______, _______, _______,
